...
test_that("NetCDF outputs are correctly parsed for 1 level of analogy, calibration", {
  expect_true(is.dir('files/optimizer-outputs/1/results'))
  A <- atmoswingRToolbox::parseNcOutputs('files/optimizer-outputs/1/results',
                                         1, 'calibration')
...
test_that("NetCDF outputs are correctly parsed for 1 level of analogy, calibration", {
  expect_true(is.dir('files/optimizer-outputs/1/results'))
  A <- atmoswingRToolbox::parseNcOutputs('files/optimizer-outputs/2/results',
                                         1, 'calibration', 2)
